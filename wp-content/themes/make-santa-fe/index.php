...
<article id="post-<?php the_ID(); ?>" class="entry-summary clearfix"  style="border:0;">

<div  class="row event-summery">
	<div class="col-sm-3 event-date">
		<div><strong><?php the_time('F jS, Y') ?></strong></div>
		<?php //the_category(', '); ?>
<!-- 			<img src="<?php echo get_wp_user_avatar_src( $user->ID, 'thumbnail' ); ?>" width="50" height="50" class="img-circle pull-right avatar" /> -->
			<a href="<?php the_permalink(); ?>" rel="bookmark"><?php echo anagram_resize_image(array('width'=>100, 'height'=>100, 'crop'=>true, 'img_class'=>"img-thumbnail img-responsive img-circle")); ?></a>
...
<div class="col-sm-9">
	...
	<div class="event-excerpt"><?php echo clean_excerpt(get_the_content(), '...' , 25 );?></div>
	<hr>
</div>
</div>
