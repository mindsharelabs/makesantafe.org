 ...
 */
 ...
 /* Anagram - only edited text because gettext was not working. */
...
<div class="gv-review-list-header" id="gv-entry-reviews">
	...
	<?php if ( $reviews_number ) : ?>
		<span class="gv-review-num-of-reviews">
			<?php printf( _n( 'One vote on this application', '%1$s votes on this application', $reviews_number, 'gravityview-ratings-reviews' ), number_format_i18n( $reviews_number ) ); ?>
		</span>
	...
	<?php else : ?>
		<span class="gv-review-num-of-reviews">
			<?php _e( 'This entry has no reviews.', 'gravityview-ratings-reviews' ); ?>
		</span>
	<?php endif; ?>
	</h2>
