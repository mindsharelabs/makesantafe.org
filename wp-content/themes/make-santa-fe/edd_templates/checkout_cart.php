...
global $post; ?>
<table id="edd_checkout_cart" class="table table-striped table-bordered" <?php if ( ! edd_is_ajax_disabled() ) { echo 'class="ajaxed"'; } ?>>
	<thead>
		...
		<?php if ( $cart_items ) : ?>
			<?php foreach ( $cart_items as $key => $item ) : ?>
				<tr class="edd_cart_item" id="edd_cart_item_<?php echo esc_attr( $key ) . '_' . esc_attr( $item['id'] ); ?>" data-download-id="<?php echo esc_attr( $item['id'] ); ?>">
					...
					<td class="edd_cart_actions form-inline  text-right">
	...
	<tfoot>
		...
		<?php if( has_action( 'edd_cart_footer_buttons' ) ) : ?>
			<tr class="edd_cart_footer_row<?php if ( edd_is_cart_saving_disabled() ) { echo ' edd-no-js'; } ?>">
				<th class="text-right" colspan="<?php echo edd_checkout_cart_columns(); ?>">
		...
		<tr class="edd_cart_footer_row">
			...
			<th colspan="<?php echo edd_checkout_cart_columns(); ?>" class="edd_cart_total  text-right"><?php _e( 'Total', 'easy-digital-downloads' ); ?>: <span class="edd_cart_amount" data-subtotal="<?php echo edd_get_cart_total(); ?>" data-total="<?php echo edd_get_cart_total(); ?>"><?php edd_cart_total(); ?></span></th>
