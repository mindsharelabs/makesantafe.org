...
class FooEvents_Calendar_Update_Helper {
    ...
    public function __construct($Config) {
        ...
        add_action('in_plugin_update_message-fooevents_calendar/fooevents-calendar.php', array($this, 'show_upgrade_notification'), 10, 2);
